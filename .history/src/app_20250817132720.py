...
class ModelWrapper:
    def __init__(self, model_name: str, device: str = "cpu"):
        self.device = device
        mlflow.set_tracking_uri("file:Experiments/mlruns")  # or your MLflow tracking URI
        # Load the Production version of the model from MLflow Registry
...
def get_model() -> ModelWrapper:
    global _model
    if _model is None:
        _model = ModelWrapper("BreastSeg", device=DEVICE)  # replace with your MLflow model name
    return _model
